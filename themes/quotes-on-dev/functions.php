...
function qod_scripts() {
	...
	wp_enqueue_script('general-scripts', get_template_directory_uri() .'/build/js/general.min.js', array('jquery'), null, true);
	...
	wp_localize_script( 'general-scripts', 'quote_vars', array(
